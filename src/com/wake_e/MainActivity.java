...
public class MainActivity extends FragmentActivity {
	 ...
	 * relative.getHeight() - ll.getHeight()));
	 * //relative.setLayoutParams(new
	 * RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT,0));
	 * 
	 * TranslateAnimation animation = new TranslateAnimation(0.0f,0.0f,0.0f,
	 * first); // new TranslateAnimation(xFrom,xTo, yFrom,yTo)
	 * animation.setDuration(1000); //animation.setFillAfter(true);
	 * ll.startAnimation(animation); ll.setY(first);
	 */
